...
class VAE(HModule):
    ...
    def forward(self, x, x_target):
        ...
        recon = torch.mean( (self.decoder.out_net._sample(px_z) - x_target)**2 )          
        ...
        return dict(elbo=elbo, distortion=distortion_per_pixel.mean(), rate=rate_per_pixel.mean(), recon=recon)
